    ...
    <footer className="bg-brand-navy text-white py-16">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li>
                <Link className="hover:text-brand-orange transition" href="/">
                  Home
                </Link>
              </li>
              <li>
                <Link className="hover:text-brand-orange transition" href="/services">
                  Services
                </Link>
              </li>
              <li>
                <Link className="hover:text-brand-orange transition" href="/about">
                  About
                </Link>
              </li>
              <li>
                <Link className="hover:text-brand-orange transition" href="/contact">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li>
                <Link className="hover:text-brand-orange transition" href="/services?service=ac">
                  AC Repair
                </Link>
              </li>
              <li>
                <Link className="hover:text-brand-orange transition" href="/services?service=electrician">
                  Electrician
                </Link>
              </li>
              <li>
                <Link className="hover:text-brand-orange transition" href="/services?service=plumber">
                  Plumber
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-white/10 mt-10 pt-6 text-center text-gray-400">
          &copy; 2026 AiroFox. All rights reserved.
        </div>
      </div>
    </footer>
  );
