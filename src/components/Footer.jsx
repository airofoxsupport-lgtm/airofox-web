        ...
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li>
                <Link className="hover:text-brand-orange transition" to="/">
                  Home
                </Link>
              </li>
              <li>
                <Link className="hover:text-brand-orange transition" to="/services">
                  Services
                </Link>
              </li>
              <li>
                <Link className="hover:text-brand-orange transition" to="/about">
                  About
                </Link>
              </li>
              <li>
                <Link className="hover:text-brand-orange transition" to="/contact">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li>
                <Link className="hover:text-brand-orange transition" to="/services?service=ac-repair">
                  AC Repair
                </Link>
              </li>
              <li>
                <Link className="hover:text-brand-orange transition" to="/services?service=electrician">
                  Electrician
                </Link>
              </li>
              <li>
                <Link className="hover:text-brand-orange transition" to="/services?service=plumber">
                  Plumber
                </Link>
              </li>
            </ul>
