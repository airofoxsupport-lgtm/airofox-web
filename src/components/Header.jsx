    ...
    <>
      ...
      <div
        ...
        <div style={{ display: 'flex', gap: '10px', padding: '12px 20px 20px' }}>
          <a href="tel:+919326065836" style={{ flex: 1 }}>
            <button style={{
          ...
          <a href="https://wa.me/919326065836?text=Hi%20AiroFox%2C%20I%20need%20to%20book%20a%20service." target="_blank" rel="noopener noreferrer" style={{ flex: 1 }}>
            <button style={{
              width: '100%', padding: '14px 0', borderRadius: '14px', border: 'none',
