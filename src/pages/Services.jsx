              ...
              >
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <div className="flex items-center gap-4 mt-10">
                    <a href="tel:+919326065836" className="inline-flex items-center justify-center rounded-xl px-5 py-3 text-sm font-semibold transition-all duration-300 gap-2 bg-transparent text-white hover:bg-white/10">
                      <svg
                    ...
                    <a
                      ...
                      className="inline-flex items-center justify-center rounded-xl px-6 py-3 text-sm font-semibold transition-all duration-300 bg-green-500 text-white hover:bg-green-600 hover:-translate-y-0.5 shadow-md gap-2"
                    >
                      <svg
                        stroke="currentColor"
                        fill="currentColor"
